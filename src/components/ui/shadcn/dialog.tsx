  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // Capped to the viewport (mirrors the existing max-w-[calc(100%-2rem)]
          // safety margin) and clipped with overflow-hidden so rounded corners
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "sticky top-0 z-10 flex flex-col gap-2 bg-popover",
        className
      )}
      {...props}
    />
