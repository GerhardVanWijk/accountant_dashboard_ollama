...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/*
          Title/description live INSIDE DialogContent (base-ui needs them in
          the popup subtree for the dialog's aria-labelledby/-describedby),
          and the cmdk children MUST be wrapped in <Command> — without the
          CommandPrimitive context provider none of CommandInput/List/Item
          work, which is what left the global search palette inert.
        */}
