...
export function AppTopbar() {
  ...
  return (
    <header data-slot="app-topbar" className="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-2 border-b border-border bg-background/85 px-3 backdrop-blur-xl sm:px-4">
