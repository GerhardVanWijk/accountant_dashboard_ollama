  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <StatTileGrid
        columns={4}
        metrics={[
          { label: 'Customers with balance', value: String(withBalanceCount), icon: UsersIcon },
          { label: 'Total receivable', value: formatCurrency(totals.total), icon: WalletCardsIcon },
