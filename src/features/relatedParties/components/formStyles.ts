/**
 * Shared Tailwind class strings for form controls across the
 * relatedParties feature's forms — semantic design tokens only, no
 * hardcoded colors (docs/DESIGN_SYSTEM.md). Mirrors
 * src/features/assets/components/formStyles.ts.
 */
