...
/** Minimal modal dialog local to the compliance feature — mirrors src/features/assets/components/Modal.tsx exactly (no shared src/components/ui Modal exists yet to reuse). */
