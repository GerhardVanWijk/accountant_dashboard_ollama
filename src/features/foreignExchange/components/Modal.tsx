...
export interface ModalProps {
  ...
  onClose: () => void;
  children: ReactNode;
  /** Widen the dialog for content-heavy forms. */
  wide?: boolean;
}

/**
 * Minimal modal dialog local to the foreignExchange feature (no shared
 * src/components/ui Modal exists yet — same pattern as
 * src/features/tax/components/Modal.tsx / src/features/accounting/components/Modal.tsx).
 * Built from design-system tokens only, see docs/DESIGN_SYSTEM.md.
 */
