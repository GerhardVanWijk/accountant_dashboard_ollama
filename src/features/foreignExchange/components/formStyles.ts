/**
 * Shared Tailwind class strings for form controls in the Foreign Exchange
 * feature's forms — semantic design tokens only, no hardcoded colors
 * (docs/DESIGN_SYSTEM.md). Mirrors src/features/tax/incomeTax/components/formStyles.ts.
 */
