...
export interface ModalProps {
  ...
  onClose: () => void;
  children: ReactNode;
  /** Widen the dialog for content-heavy forms (e.g. the line-item editor). */
  wide?: boolean;
}

/**
 * Minimal modal dialog local to the sales feature (no shared
 * src/components/ui Modal exists yet — same pattern as
 * src/features/purchases/components/Modal.tsx,
 * src/features/banking/components/Modal.tsx, and
 * src/features/accounting/components/Modal.tsx). Built from design-system
