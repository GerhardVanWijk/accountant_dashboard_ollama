 ...
 * reference data (src/mock-data/taxRates.ts) — the same "no real Tax
 * module yet" lookup src/features/purchases/components/LineItemsEditor.tsx
 * already uses; not invented here, and never a hardcoded rate per this
 * dispatch's brief.
 */
