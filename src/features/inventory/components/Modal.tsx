...
/**
 * Minimal modal dialog local to the inventory feature (no shared
 * src/components/ui Modal exists yet to reuse). Built from design-system
 * tokens only — see docs/DESIGN_SYSTEM.md. Used by the Product/Warehouse
 * create-edit forms and the Stock Transfer/Adjustment forms.
 */
