    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'settings/subscription', element: <PermissionRoute feature="billing" action="read" area="Plan & billing"><SubscriptionPage /></PermissionRoute> },
          ...
          { path: 'financial-periods', element: <PermissionRoute feature="financial_periods" action="read"><FinancialPeriodsPage /></PermissionRoute> },
          { path: 'sales/customers', element: <PermissionRoute feature="customer_management" action="read"><CustomersPage /></PermissionRoute> },
          { path: 'sales/quotes', element: <PermissionRoute feature="sales_documents" action="read"><QuotesPage /></PermissionRoute> },
          { path: 'sales/quotes/:quoteId', element: <PermissionRoute feature="sales_documents" action="read"><QuoteDetailPage /></PermissionRoute> },
          { path: 'sales/orders', element: <PermissionRoute feature="sales_documents" action="read"><SalesOrdersPage /></PermissionRoute> },
          { path: 'sales/orders/:orderId', element: <PermissionRoute feature="sales_documents" action="read"><SalesOrderDetailPage /></PermissionRoute> },
          { path: 'sales/orders/:orderId/deliver', element: <PermissionRoute feature="sales_documents" action="read"><CreateDeliveryNotePage /></PermissionRoute> },
          { path: 'sales/delivery-notes', element: <PermissionRoute feature="fulfilment" action="read"><DeliveryNotesPage /></PermissionRoute> },
          { path: 'sales/delivery-notes/:deliveryNoteId', element: <PermissionRoute feature="fulfilment" action="read"><DeliveryNoteDetailPage /></PermissionRoute> },
          { path: 'sales/delivery-notes/:deliveryNoteId/return', element: <PermissionRoute feature="fulfilment" action="read"><CreateReturnNotePage /></PermissionRoute> },
          { path: 'sales/return-notes', element: <PermissionRoute feature="fulfilment" action="read"><ReturnNotesPage /></PermissionRoute> },
          { path: 'sales/return-notes/:returnNoteId', element: <PermissionRoute feature="fulfilment" action="read"><ReturnNoteDetailPage /></PermissionRoute> },
          ...
          { path: 'sales/credit-notes', element: <PermissionRoute feature="sales_documents" action="read"><CreditNotesPage /></PermissionRoute> },
          { path: 'sales/credit-notes/:creditNoteId', element: <PermissionRoute feature="sales_documents" action="read"><CreditNoteDetailPage /></PermissionRoute> },
          { path: 'sales/receipts', element: <PermissionRoute feature="sales_documents" action="read"><CustomerReceiptsPage /></PermissionRoute> },
          { path: 'sales/receipts/:receiptId', element: <PermissionRoute feature="sales_documents" action="read"><CustomerReceiptDetailPage /></PermissionRoute> },
          { path: 'purchases/vendors', element: <PermissionRoute feature="supplier_management" action="read"><VendorsPage /></PermissionRoute> },
          { path: 'purchases/orders', element: <PermissionRoute feature="purchasing" action="read"><PurchaseOrdersPage /></PermissionRoute> },
          { path: 'purchases/orders/:purchaseOrderId', element: <PermissionRoute feature="purchasing" action="read"><PurchaseOrderDetailPage /></PermissionRoute> },
          { path: 'purchases/bills', element: <PermissionRoute feature="purchasing" action="read"><BillsPage /></PermissionRoute> },
          { path: 'purchases/bills/:billId', element: <PermissionRoute feature="purchasing" action="read"><BillDetailPage /></PermissionRoute> },
          { path: 'purchases/payments', element: <PermissionRoute feature="purchasing" action="read"><PaymentsPage /></PermissionRoute> },
          { path: 'purchases/payments/:paymentId', element: <PermissionRoute feature="purchasing" action="read"><SupplierPaymentDetailPage /></PermissionRoute> },
          { path: 'purchases/aging', element: <PermissionRoute feature="purchasing" action="read"><VendorAgingPage /></PermissionRoute> },
          { path: 'banking/accounts', element: <PermissionRoute feature="banking" action="read"><BankAccountsPage /></PermissionRoute> },
          { path: 'banking/transactions', element: <PermissionRoute feature="banking" action="read"><BankTransactionsPage /></PermissionRoute> },
          { path: 'banking/reconciliation', element: <PermissionRoute feature="banking" action="read"><BankReconciliationPage /></PermissionRoute> },
          ...
          { path: 'assets/register', element: <PermissionRoute feature="assets" action="read"><AssetRegisterPage /></PermissionRoute> },
          { path: 'assets/depreciation', element: <PermissionRoute feature="assets" action="read"><DepreciationPage /></PermissionRoute> },
          { path: 'assets/disposals', element: <PermissionRoute feature="assets" action="read"><DisposalsPage /></PermissionRoute> },
          { path: 'assets/tax-register', element: <PermissionRoute feature="assets" action="read"><TaxRegisterPage /></PermissionRoute> },
          ...
          { path: 'tax/rates', element: <PermissionRoute feature="tax" action="read"><TaxRatesPage /></PermissionRoute> },
          { path: 'tax/vat-return', element: <PermissionRoute feature="tax" action="read"><VatReturnPage /></PermissionRoute> },
          { path: 'tax/income-tax', element: <PermissionRoute feature="tax" action="read"><IncomeTaxPage /></PermissionRoute> },
          { path: 'tax/capital-gains', element: <PermissionRoute feature="tax" action="read"><CapitalGainsPage /></PermissionRoute> },
          { path: 'tax/dividends', element: <PermissionRoute feature="tax" action="read"><DividendsTaxPage /></PermissionRoute> },
          { path: 'tax/provisional-tax', element: <PermissionRoute feature="tax" action="read"><ProvisionalTaxPage /></PermissionRoute> },
          { path: 'tax/deferred-tax', element: <PermissionRoute feature="tax" action="read"><DeferredTaxPage /></PermissionRoute> },
          { path: 'tax/expected-credit-losses', element: <PermissionRoute feature="tax" action="read"><EclProvisionPage /></PermissionRoute> },
          ...
          { path: 'compliance/dashboard', element: <PermissionRoute feature="compliance" action="read"><ComplianceDashboardPage /></PermissionRoute> },
          { path: 'compliance/public-interest-score', element: <PermissionRoute feature="compliance" action="read"><PublicInterestScorePage /></PermissionRoute> },
          { path: 'compliance/reporting-standards', element: <PermissionRoute feature="compliance" action="read"><ReportingStandardsPage /></PermissionRoute> },
          { path: 'related-parties/register', element: <PermissionRoute feature="compliance" action="read"><RelatedPartyRegisterPage /></PermissionRoute> },
          { path: 'related-parties/transactions', element: <PermissionRoute feature="compliance" action="read"><RelatedPartyTransactionsPage /></PermissionRoute> },
          { path: 'foreign-exchange/rates', element: <PermissionRoute feature="compliance" action="read"><ExchangeRatesPage /></PermissionRoute> },
          ...
          { path: 'documents', element: <PermissionRoute feature="documents" action="read"><DocumentsPage /></PermissionRoute> },
          { path: 'notifications', element: <PermissionRoute feature="notifications" action="read"><NotificationsPage /></PermissionRoute> },
          { path: 'settings', element: <PermissionRoute feature="settings" action="read"><SettingsPage /></PermissionRoute> },
          { path: 'settings/accounting', element: <PermissionRoute feature="accounting_settings" action="read" area="Accounting settings"><AccountingSettingsPage /></PermissionRoute> },
